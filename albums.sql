...
value
    ...
    ('Pink Floyd', 'Dark Side of the Moon', 1973, 'Progressive Rock', 24.2),
    ('Meat Loaf', 'Bat Out of Hell', 1977, 'Hard Rock, Progressive Rock', 21.5),
    ('Whitney Houston / Various Artists', 'The Bodyguard', 1992, 'R&B, Soul,
Pop, Soundtrack', 28.4),
    ('The Eagles', 'Their Greatest Hits (1971-1975)', 1976, 'Rock, Soft
Rock, Folk Rock', 32.2),
    ('Bee Gees / Various Artists', 'Saturday Night Fever', 1977, 'Disco', 21.6),
    ('Fleetwood Mac', 'Rumors', 1977, 'Soft Rock', 27.9),
    ('Various Artists', 'Grease: The Original Soundtrack from the Main
Motion Pictures', 1978, 'Soundtrack', 14.4),
    ('Led Zeppelin', 'Led Zeppelin IV', 1971, 'Hard Rock, Heavy Metal, Folk',
     29.0),
    ('Michael Jackson', 'Bad', 1987, 'Pop, Funk, Rock', 19.3),
    ('Alanis Morissette', 'Jagged Little Pill', 1995, 'Alternative Rock', 24.4),
    ('Shania Twain', 'Come On Over', 1996, 'Country, Pop', 29.6),
    ('Celine Dion', 'Falling Into You', 1996, 'Pop, Soft Rock', 20.2),
    ('The Beatles', 'Sgt. Pepper''s Lonely Hearts Club Band', 1967, 'Rock',
     13.1),
    ('The Eagles', 'Hotel California', 1976, 'Rock, Soft Rock, Folk Rock',
     21.5),
    ...
    ('Nirvana', 'Nevermind', 1991, 'Grunge, Alternative Rock', 1991),
